...
public class DriverData implements Parcelable{
    ...
    public DriverData(String DLImage, String RCImage , String insuranceImage, String taxPaidImage,String name, String phone, String profileImage,String hypertrack_id) {
        this.DLImage = DLImage;
        this.RCImage = RCImage;
        this.hypertrack_id=hypertrack_id;
    ...
    public String getHypertrack_id() {
        return hypertrack_id;
    }

    public void setHypertrack_id(String hypertrack_id) {
        this.hypertrack_id = hypertrack_id;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(hypertrack_id);
    }
}
